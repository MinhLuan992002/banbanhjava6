...
//			;
  ...
  UserDetailsService userDetailManager() {    	
		return new InMemoryUserDetailsManager(
				...
				User.withUsername("ML09").password(passwordEncoder().encode("123")).roles("ADMIN").build(),
				User.withUsername("ND09").password(passwordEncoder().encode("123")).roles("USER").build(),
